  ...
  return (
    <div className="home-page" dir="rtl">
      ...
      <div className="footer-parallax-wrapper" style={{ position: 'relative', width: '100%' }}>
        ...
        <section className="schedules-section content-section" ref={addToRefs} dir="rtl" style={{ position: 'sticky', bottom: '0', zIndex: 1, paddingBottom: '10vh', paddingTop: '5vh', minHeight: '100vh' }}>
